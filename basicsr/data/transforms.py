...
def random_transform(inputs, target):
    """
    ...
    Args:
        input, target : the input and target 3D patch before data augmentation
    Return:
        input, target : the input and target 3D patch after data augmentation
    """
