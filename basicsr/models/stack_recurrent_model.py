...
class StackRecurrentModel(VideoBaseModel):

    def __init__(self, opt):
        super(StackRecurrentModel, self).__init__(opt)
        if self.is_train:
    ...
    #
    #     super(StackRecurrentModel, self).optimize_parameters(current_iter)
