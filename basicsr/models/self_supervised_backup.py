        ...
        if stitching:
            if save_img:
                ...
                for k, im_name in enumerate(im_names):
                    val_data = dataset[k]
                    h_num, w_num = val_data['split_num'], val_data['split_num']
                    im = io.imread(os.path.join(img_path, im_name))
                    # print('stitching  ', im_name)
                    i = kk // w_num  # i row idx
                    j = kk % w_num  # j col idx
