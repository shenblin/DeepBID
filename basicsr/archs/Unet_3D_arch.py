...
from .Unet_3D_build_blocks import Encoder, Decoder, FinalConv, DoubleConv, ExtResNetBlock, SingleConv
...
class UNet_3D(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid = True, f_maps=64, layer_order='cr', num_groups=8,
                 **kwargs):
